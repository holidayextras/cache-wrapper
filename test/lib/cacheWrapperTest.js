...
describe( 'Cache', function() {
	...
	it( 'should fail to set an item in the cache before it has intialised', function() {
	...
	describe( 'Cache not ready, queue it', function() {
	...
	describe( 'Cache start error', function() {
